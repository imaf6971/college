...
const Home: NextPage = () => {
  ...
  return (
    <>
      <Head>
        <title>Главная</title>
        <meta name="description" content="Основная страница" />
      </Head>
...
//       <p classNameName="text-center text-2xl text-white">
//         {sessionData && <span>Logged in as {sessionData.user?.name}</span>}
//         {secretMessage && <span> - {secretMessage}</span>}
//       </p>
//       <button
//         classNameName="rounded-full bg-white/10 px-10 py-3 font-semibold text-white no-underline transition hover:bg-white/20"
